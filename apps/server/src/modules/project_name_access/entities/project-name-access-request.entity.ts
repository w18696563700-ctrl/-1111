...
@Index('idx_project_name_access_requests_project_requester_created', ['projectId', 'requesterOrganizationId', 'createdAt'])
@Entity({ name: 'project_name_access_requests' })
export class ProjectNameAccessRequestEntity {
