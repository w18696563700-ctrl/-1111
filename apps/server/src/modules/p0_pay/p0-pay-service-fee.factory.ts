...
export class P0PayServiceFeeFactory {
  ...
  buildAuthorization(input: {
    ...
    return this.authorizationRepository.create({
      ...
      baseFeeAmount: input.feeRequirement.baseFeeAmount,
      membershipDiscountRate: input.feeRequirement.membershipDiscountRate,
      capAmount: input.feeRequirement.capAmount,
