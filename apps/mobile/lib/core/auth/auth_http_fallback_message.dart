String authFallbackMessage({
  ...
  return switch (statusCode) {
    400 => switch (canonicalPath) {
      ...
      '/api/app/auth/password/login' => '当前账号密码登录请求无效，请检查后重试。',
      '/api/app/auth/password/set' => '当前设置密码请求无效，请检查后重试。',
      '/api/app/auth/password/reset' => '当前重置密码请求无效，请检查后重试。',
    ...
    401 => switch (canonicalPath) {
      ...
      '/api/app/auth/password/login' => '当前账号密码未通过校验，请重试。',
      '/api/app/auth/password/set' =>
        '当前登录态不可用，请重新登录后再试。',
    ...
    429 => switch (canonicalPath) {
      ...
      '/api/app/auth/password/login' => '当前账号密码登录请求过于频繁，请稍后再试。',
      '/api/app/auth/password/set' => '当前设置密码请求过于频繁，请稍后再试。',
      '/api/app/auth/password/reset' => '当前重置密码请求过于频繁，请稍后再试。',
      _ => '当前请求过于频繁，请稍后再试。',
    },
    503 => switch (canonicalPath) {
      '/api/app/auth/otp/send' => '当前验证码发送能力暂不可用，请稍后再试。',
      '/api/app/auth/otp/login' => '当前登录能力暂不可用，请稍后再试。',
      '/api/app/auth/password/login' => '当前账号密码登录能力暂不可用，请稍后再试。',
      '/api/app/auth/password/set' => '当前设置密码能力暂不可用，请稍后再试。',
      '/api/app/auth/password/reset' => '当前重置密码能力暂不可用，请稍后再试。',
