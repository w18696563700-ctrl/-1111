...
const List<_MyProjectStageOption> _myProjectPrimaryStageOptions =
    <_MyProjectStageOption>[
      ...
      _MyProjectStageOption(
        ...
        label: '预发布列表',
        description: '项目已经进入发布前核对阶段，当前可先补充项目详情文书，再确认正式发布。',
        cardNextStep: '查看详情 / 补充资料 / 检查无误，确定发布 / 返回草稿继续编辑 / 作废归档',
        detailNextStep: '当前应先检查无误并补充项目详情文书；确认完成后再正式发布。',
...
const _MyProjectLifecycleActionOption _publishLifecycleAction =
    _MyProjectLifecycleActionOption(
      ...
      confirmMessage: '确认无误后，项目将正式进入公域展示。',
      confirmLabel: '确认发布',
...
const _MyProjectLifecycleActionOption _withdrawLifecycleAction =
    _MyProjectLifecycleActionOption(
      ...
      confirmMessage: '撤回后项目会回到草稿，可继续编辑。',
      confirmLabel: '确认撤回',
